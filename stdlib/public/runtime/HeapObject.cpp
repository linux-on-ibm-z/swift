...
static inline bool isValidPointerForNativeRetain(const void *p) {
  ...
  // On these platforms, except s390x, the upper half of address space is reserved for
  // the kernel, so we can assume that pointer values in this range are invalid.
